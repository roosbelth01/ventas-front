...
import { ColorScheme, LayoutService, MenuColorScheme, MenuMode } from '../../../core/services/app.layout.service';
...
@Component({
  selector: 'app-config',
  standalone: true,
  imports: [SidebarModule, RadioButtonModule, FormsModule, NgClass, NgStyle, InputSwitchModule, ButtonModule],
